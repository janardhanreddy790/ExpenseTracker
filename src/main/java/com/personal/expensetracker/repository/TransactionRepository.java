...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
  ...
  @Query("SELECT FUNCTION('to_char', t.date, 'YYYY-MM'), SUM(t.amount) FROM Transaction t " +
         "GROUP BY FUNCTION('to_char', t.date, 'YYYY-MM') ORDER BY FUNCTION('to_char', t.date, 'YYYY-MM') ASC")
